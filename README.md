...
Para isso devemos baixar o ChromeDriver seguindo as instruções do Splinter para cada sistema operacional:([Instruções para baixar chorme dri ](https://sites.google.com/a/chromium.org/chromedriver/downloads)).
